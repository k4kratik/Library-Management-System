...
b1=Button(root,text="Add Entry",width=12,command=entry_command)
b1.grid(row=4,column=3)

b1=Button(root,text="Update Selected",width=12,command=update_command)
b1.grid(row=5,column=3)

b1=Button(root,text="Delete Entry",width=12,command=delete_command)
